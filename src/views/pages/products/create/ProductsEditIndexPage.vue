<template>
    <section class="product-create-page">
        <div class="product-create-form">
            <h1 class="page-heading text-center">Редактирование Товара</h1>
            ...
            <div class="default-form">
                <el-form>
                    ...
                    <product-additional-images-upload :existing_images="product.additional_images"/>
    ...
    export default {
        ...
        methods: {
            deleteProduct: function () {
                ProductResource.deleteProduct(this.$route.params.product_id).then(res => {
                    this.$notify({
                        title: 'Готово',
            ...
            fetchInitialData: function () {
                ProductResource.getProduct(this.$route.params.product_id).then(res => {
            ...
            submitProductForm: function () {
                ProductResource.updateProduct(this.product.id, this.product).then(res => {
                    this.$notify({
                        title: 'Готово',
